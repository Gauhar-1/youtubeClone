...
import { useHandleCategory } from "./handleCategory"

export const FullSideBar = (props : any)=> {
    return <div className="">
        <div className="max-lg:hidden">
        <div className="flex flex-col m-3 ">

                {/* Home icon */}
            <div  className="flex  hover:bg-slate-900 rounded-md pt-2 pl-1 pr-20 pb-2" onClick={()=> {useHandleCategory(10, props.setCategory)}}>
                <div className="ml-2 ">
...
<p className="text-xs pt-1 ml-5 font-medium ">Home</p>
                ...
                {/* Shorts button */}
            <div className="flex  hover:bg-slate-900 rounded-md pt-2 pl-1 pr-20 pb-2 "  onClick={()=> {props.setCategory(10)}}>
