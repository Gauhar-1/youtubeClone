export const SideVideoCard = (props : any) => {
    return (
        <div className="grid grid-cols-2 space-x-4  ">
            ...
            <div className="absolute bottom-4 -right-2 bg-black text-white rounded-lg p-1 text-sm  ">2:04 </div>
            </div>
            </div>
            <div className="m-3 pl-2 pr-2" >
                <div className="flex space-x-1 ">
                <div className="text-base text-sm">{props.title}</div>
                ...
                <div className="flex space-x-1">
                <div className="text-base text-gray-500 text-xs">{props.channel}</div>
                <div className="">
