export const SideBar = () => {
    return (
      <div className="fixed top-0 left-0 h-screen w-20 pt-4 bg-black text-white flex flex-col items-center space-y-8 overflow-hidden hover:overflow-y-auto scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-transparent">
        <div className="flex flex-col space-y-7">
          ...
          <div className="flex flex-col items-center cursor-pointer">
            ...
            <p className="text-xs pt-2">Shorts</p>
          </div>
          ...
          <div className="flex flex-col items-center cursor-pointer">
            ...
            <p className="text-xs pt-2">Profile</p>
          </div>
        </div>
      </div>
    );
